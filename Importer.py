...
def importer():
    ...
    print(map_list)
    print('Copying tiles ...')
#    with open('imported_places.json', 'r') as o2:
    with open('imported_regions.json', 'r') as o2:
        tiles = json.load(o2)
        copy_tiles(tiles, map_list)
